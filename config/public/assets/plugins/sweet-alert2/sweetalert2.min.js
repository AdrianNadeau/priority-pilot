!(function (e, t) {
  ...
  var t = "SweetAlert2:",
    ...
    te = function (e) {
      for (var t = C(), n = 0; n < t.length; n++) {
        W(t[n]);
      }
      if (e.type) {
        if (-1 !== Object.keys(f).indexOf(e.type)) {
          var o = Le.getPopup().querySelector(
            ".".concat(I.icon, ".").concat(f[e.type]),
          );
            ...
            r((n = t).prototype, [
              {
                key: "_main",
                value: function (e) {
                  return d(c(t.prototype), "_main", this).call(
                    this,
                    s({}, i, e),
                  );
                },
  ...
  function ge() {
    ...
    e.showConfirmButton ||
      (W(t.confirmButton), e.showCancelButton || W(t.actions)),
    ...
    Pe = Object.freeze({
      ...
      _main: function (e) {
        ...
        !(function (t) {
          ...
          t.showCloseButton
            ? (c.setAttribute("aria-label", t.closeButtonAriaLabel), z(c))
            : W(c),
          (e.className = I.popup),
          t.toast
              ...
              t = function (e) {
                ...
                case "click":
                  if (i && M.isVisible()) {
                    ...
                    r &&
                        M.isVisible() &&
                        (E.disableButtons(), s(M.DismissReason.cancel));
                  }
                }
              },
              ...
              ((se.keydownHandler = function (e) {
                return (function (e, t) {
                  if (
                    ...
                    if ("Tab" === e.key) {
                      for (
                        var n = e.target, o = Y(t.focusCancel), i = -1, r = 0;
                        r < o.length;
                        r++
                      ) {
                        if (n === o[r]) {
                      ...
                      [
                        ...
                        ? document.activeElement === O.confirmButton &&
                          K(O.cancelButton)
