  ...
  r(b, [m], function (e) {
    function t(n) {
      ...
      function w(e, t, r, i) {
        ...
        for (
          l = n.findCommonAncestor(e, r), c = e;
          c && c.parentNode != l;
      ...
      function n() {
        function n(e) {
          var n = t(o, e),
            ...
            u;
          if (
            ((r = n.node), (i = n.offset), n.inside && !r.hasChildNodes())
          ) {
  ...
  r($, [z, _, w, T, U, W, V], function (e, t, n, r, i, o, a) {
    ...
    function u(e) {
      ...
      var u = [],
        ...
        h;
      if (y(e.container())) {
        return l(e.container(), e.offset()), u;
      }
      if (f(e.container())) {
        if (e.isAtEnd()) {
      ...
      a = e.extend({
        ...
        match: function (e, t) {
          ...
          for (t = t || this._selectors, n = 0, r = t.length; r > n; n++) {
            for (
              a = t[n], o = a.length, p = e, h = 0, i = o - 1;
              i >= 0;
              i--
            ) {
              for (c = a[i]; p; ) {
        ...
        function b() {
          ...
          function o(e, t) {
            ...
            for (n = e.nextSibling; n && n != t; n = n.nextSibling) {
              if (
                (3 != n.nodeType || 0 !== Z.trim(n.data).length) &&
                  n !== t
              ) {
                return !1;
              }
          ...
          function h(e, t) {
            ...
            if (
              ...
              if (1 == d.nodeType) {
                if (((d = d.childNodes[h]), d && "BR" != d.tagName)) {
                  return;
                }
                if (
    ...
    function c(e, r, i, o, a, s) {
      function c(o) {
        ...
        for (
          ...
          if (((l = c[s]), !i(l, h))) {
            if (
              (f.length > 0 && r(l, t.last(f)) && u++, (l.line = u), a(l))
            ) {
              return !0;
            }
            f.push(l);
