  ...
  function Qa(c, e) {
    ...
    function l(b, c) {
      ga++,
        ...
        !Z &&
          ...
          Z.setElement(
            a("<div class='fc-view fc-" + b + "-view' />").appendTo(W),
          ),
          V.activateButton(b)),
        Z &&
    ...
    function R(a) {
      ...
      if (1 === c) {
        ...
        if ("businessHours" === b) {
          return void (
            Z && (Z.unrenderBusinessHours(), Z.renderBusinessHours())
          );
        }
        if ("timezone" === b) {
    ...
    (aa =
      ...
      (T.isHeightAuto = function () {
        return (
          "auto" === T.options.contentHeight || "auto" === T.options.height
        );
      }),
  ...
  function Ua() {
    ...
    function i(b, c) {
      ...
      for (d = 0; d < f.length; d++) {
        if (
          ((e = f[d].call(U, b, W.clone(), X.clone(), U.options.timezone, c)),
          e === !0)
        ) {
          return;
        }
    ...
    function C(c, d) {
      ...
      if (
        ...
        f && ((f = U.moment(f)), f.isValid() || (f = null)),
          (g = c.allDay),
          void 0 === g &&
            (g = ba(d ? d.allDayDefault : void 0, U.options.allDayDefault)),
          D(e, f, g, h);
      }
    ...
    function O(b, c, d) {
      var e, f;
      return (
        d && ((e = a.extend({}, d, c)), (f = G(C(e))[0])), f ? K(b, f) : P(b)
      );
    }
    function P(a) {
