...
ORDER BY
  ...
  try {
    ...
    // Deduplicate projects by ID (status JOIN can produce duplicate rows when two statuses share the same max date)
    ...
    // Process deduplicated projects to calculate phase totals
