  ...
  try {
    ...
    if (updated) {
      ...
      const newChangedProject = {
        ...
        project_why: req.body.project_why,
        project_what: req.body.project_what,
        priority_id_fk: req.body.priority_id_fk ?? 0,
        sponsor_id_fk: req.body.sponsor_id_fk ?? 0,
        prime_id_fk: req.body.prime_id_fk ?? 1,
        phase_id_fk: req.body.phase_id_fk ?? 1,
        impact: req.body.impact ?? 1,
        complexity: req.body.complexity ?? 1,
